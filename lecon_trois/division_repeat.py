...
number_mille = (number - number_cent * 100 - number_dix * 10 - number_un) % 10000 // 1000
number_dix_mille = (number - number_mille * 1000 - number_cent * 100 - number_dix * 10 - number_un) % 100000 // 10000

number_modify = str(number_dix_mille) + '0' + str(number_cent) + '0' + str(number_un)
