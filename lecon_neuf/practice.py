...
countries_info = [{'country': 'Italy', 'population': 81,
                   'cities': ['Rome', 'Milano', 'Torino']},
                  {'country': 'France', 'population': 75,
...
print(create_country_info('Italy', '81', ['Rome', 'Torino', 'Milano',
                                          'Bergamo', 'Palermo', 'Triest']))

# 11. Создайте словарь с помощью функции create_country_info
#     и вставьте его в начало списка countries_info
temp_2 = create_country_info('Turkmenistan', '6', ['Ashgabat', 'Turkmenabat',
                                                   'Daşoguz'])
